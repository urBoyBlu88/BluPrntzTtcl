...
static const unsigned char image__17_172351_afterburner_crosshair_crosshair_png_bits[] U8X8_PROGMEM = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x3f,0x00,0xf8,0x3f,0x00,0x00,0x00,0xf8,0x3f,0x00,0xf8,
0x3f,0x00,0x00,0x00,0xf8,0x3f,0x00,0xf8,0x3f,0x00,0x00,0x00,0x78,0x00,0x00,0x00,0x3c,0x00,0x00,0x00,0x78,0x00,0x00,0x00,0x3c,0x00,0x00,0x00,0x78,
0x00,0x00,0x00,0x3c,0x00,0x00,0x00,0x78,0x00,0x00,0x00,0x3c,0x00,0x00,0x00,0x78,0x00,0x00,0x00,0x3c,0x00,0x00,0x00,0x78,0x00,0x00,0x00,0x3c,0x00,
0x00,0x00,0x78,0x00,0x00,0x00,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
,
...
void SquareReticleAndPin(){
    ...
    //   if(buf[0] == 'f'){
      ...
      u8g2.setFontMode(1);
      u8g2.setBitmapMode(1);
      u8g2.drawXBMP(7, 0, 57, 40, image__17_172351_afterburner_crosshair_crosshair_png_bits);
      //u8g2.drawXBMP(30, 12, 11, 16, image_crosshairs_bits);
      u8g2.sendBuffer();
}
...
u8g2.setFontMode(1);
u8g2.setBitmapMode(1);
u8g2.drawXBMP(16, 2, 37, 40, image_kittyHelo_bits);
u8g2.sendBuffer();
}
// 'elcan', 72x40px
...
void Elcan(){
   u8g2.setFontMode(1);
      ...
      u8g2.drawXBMP(0, 0, 72, 40, epd_bitmap_elcan);
      u8g2.sendBuffer();
}
...
u8g2.setFontMode(1);
u8g2.setBitmapMode(1);
u8g2.drawXBMP(0, 0, 80, 40, image__230505_Yevgeny_Prigozhin_al_0751_f1ef79_bits);
u8g2.sendBuffer();
delay(500);
u8g2.clearBuffer();
u8g2.setFontMode(1);
u8g2.setBitmapMode(1);
u8g2.drawXBMP(16, 0, 40, 40, image_images_bits);
u8g2.sendBuffer();
delay(500);
}
...
u8g2.setFontMode(1);
u8g2.setBitmapMode(1);
u8g2.drawXBMP(-5, 2, 86, 40, image_goatsepolo_bits);
u8g2.sendBuffer();
}
...
u8g2.setFontMode(1);
u8g2.setBitmapMode(1);
u8g2.drawXBMP(22, 0, 30, 40, image__9e4e367c_9b05_4bba_b76d_e01ff2fe8b7d___CR0_0_300_400_PT0_SX300_V1____bits);
u8g2.sendBuffer();
}
...
u8g2.setFontMode(1);
u8g2.setBitmapMode(1);
u8g2.drawXBMP(0, 0, 71, 40, image_J_27yjq8N5hupmKZHHgl9ktVTknVGYmqi1FcPfizeOs_bits);
u8g2.sendBuffer();
}
...
u8g2.setFontMode(1);
u8g2.setBitmapMode(1);
u8g2.drawXBMP(16, 0, 40, 40, image_frame_03_delay_0_03s_bits);
u8g2.sendBuffer();
}
